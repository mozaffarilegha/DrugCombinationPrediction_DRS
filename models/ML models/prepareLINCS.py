...
for k in range(nfolds):
    ...
    concatenated_df.to_csv(f"{features_folder}{k}_train_DEG.csv", index=False)
    ...
    concatenated_df_test.to_csv(f"{features_folder}{k}_test_DEG.csv", index=False)
    ...
    concatenated_df_val.to_csv(f"{features_folder}{k}_val_DEG.csv", index=False)
