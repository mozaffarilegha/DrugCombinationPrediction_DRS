...
# Drug features 
drugdata = pd.read_csv('substrFeatures.csv')
...
for k in range(nfolds):
    ...
    concatenated_df.to_csv(f"{features_folder}{k}_train_sub.csv", index=False)
    ...
    concatenated_df_test.to_csv(f"{features_folder}{k}_test_sub.csv", index=False)
