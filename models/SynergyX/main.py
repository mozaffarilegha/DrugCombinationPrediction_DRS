...
def main():
    ...
    if args.mode == 'train':
        ...
        tr_dataloader , val_dataloader, test_dataloader = load_dataloader(n_fold=k,args=args)
        l1,l2,l3,l4,l5,l6,l7,_ = validate(model=model,criterion=criterion,dataloader=test_dataloader,device=device,args=args)
        print('Test reslut: mse:{:.4f} rmse:{:.4f} mae:{:.4f} r2:{:.4f} pearson:{:.4f} spearman:{:.4f} AUC{:.4f}\n'.format(l1,l2,l3,l4,l5,l6,l7))
