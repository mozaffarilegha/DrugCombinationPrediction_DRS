...
from sklearn.metrics import roc_auc_score, average_precision_score, precision_recall_curve, auc, f1_score, accuracy_score, precision_score, recall_score, cohen_kappa_score, mean_squared_error
...
def validate(model,criterion,dataloader,device,args=None):
    ...
    y_test_binary = [ 1 if x >= 30 else 0 for x in y_true ]
    ...
    m1,m2,m3,m4,m5,m6,m7, m8, m9, m10, m11, m12, m13 = mse,rmse,mae,r2,pearson,spearman,auc_score, accuracy, f1, precision, recall, kappa, None

    return m1,m2,m3,m4,m5,m6,m7, m8, m9, m10, m11, m12, m13
